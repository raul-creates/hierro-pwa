...
- **Inicio**: la pestaña Inicio (hoy "Log") pasa a mostrar por defecto lo que hoy muestra la pestaña Rutinas — manteniendo el header de HIERRO y la ruedita de configuración. La pestaña "Rutinas" separada del bottom-nav se elimina (bottom-nav queda en 4 botones: Inicio, Empezar, Stats, Guía).
- **Stats/Historial**: el Log se fusiona dentro de Stats, siguiendo el patrón de openGym — sección "Sesiones recientes" (últimas 6) dentro de Stats, con un botón/ícono que lleva a una pantalla de historial completo aparte (todas las sesiones, más reciente primero).

_Última actualización: 2026-09-15 (Rutinas: autoguardado) — roadmap A–I completo + 2 de 3 ideas sueltas + 1 de 3 partes del rediseño Inicio/Rutinas/Stats._
